...
Function GetHelper() {
    ...
    if (!(Test-Path $helper))
    {
        Start-BitsTransfer "https://raw.githubusercontent.com/$GithubSDNRepository/test/Kubernetes/windows/helper.psm1" -Destination $helper
    }
...
Function DownloadAllFiles() {
    ...
    DownloadFile "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/l2bridge/cni/flannel.exe" $cniDir\flannel.exe
    DownloadFile "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/l2bridge/cni/host-local.exe" $cniDir\host-local.exe
    DownloadFile "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/l2bridge/cni/win-bridge.exe" $cniDir\win-bridge.exe
    ...
    DownloadFile "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/windows/hns.psm1" (Join-Path $kubernetesPath hns.psm1)
    DownloadFile "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/l2bridge/net-conf.json" (Join-Path $kubernetesPath net-conf.json)
    ...
    DownloadFile "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/containerd/containerd-config.toml" $containerdPath\config.toml
