...
if (!(Test-Path $helper))
{
    Start-BitsTransfer "https://raw.githubusercontent.com/$GithubSDNRepository/test/Kubernetes/windows/helper.psm1" -Destination $BaseDir\helper.psm1
}
ipmo $helper

DownloadFile -Url "https://raw.githubusercontent.com/$GithubSDNRepository/test/Kubernetes/windows/debug/VFP.psm1" -Destination $BaseDir\VFP.psm1
