...
$GithubSDNRepository = 'rjaini/SDN'
...
function DownloadCniBinaries($NetworkMode)
{
    ...
    DownloadFile -Url  "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/$NetworkMode/net-conf.json" -Destination $BaseDir\net-conf.json
    DownloadFile -Url "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/$NetworkMode/cni/config/cni.conf" -Destination $BaseDir\cni\config\cni.conf
    DownloadFile -Url  "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/l2bridge/cni/flannel.exe" -Destination $BaseDir\cni\flannel.exe
    DownloadFile -Url  "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/l2bridge/cni/host-local.exe" -Destination $BaseDir\cni\host-local.exe

    if ($NetworkMode -eq "l2bridge")
    {
        DownloadFile -Url  "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/l2bridge/cni/win-bridge.exe" -Destination $BaseDir\cni\win-bridge.exe
    }
    elseif ($NetworkMode -eq "overlay"){
        DownloadFile -Url  "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/overlay/cni/win-overlay.exe" -Destination $BaseDir\cni\win-overlay.exe
    }
}
...
function DownloadWindowsKubernetesScripts
{
    ...
    DownloadFile -Url "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/windows/hns.psm1" -Destination $BaseDir\hns.psm1
    DownloadFile -Url "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/windows/Dockerfile" -Destination $BaseDir\Dockerfile
    DownloadFile -Url "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/stop.ps1" -Destination $BaseDir\stop.ps1
    DownloadFile -Url "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/start-kubelet.ps1" -Destination $BaseDir\start-kubelet.ps1
    DownloadFile -Url "https://github.com/$GithubSDNRepository/raw/test/Kubernetes/flannel/start-kubeproxy.ps1" -Destination $BaseDir\start-Kubeproxy.ps1
}
...
if (!(Test-Path $helper))
{
    Start-BitsTransfer "https://raw.githubusercontent.com/$GithubSDNRepository/test/Kubernetes/windows/helper.psm1" -Destination c:\k\helper.psm1
}
ipmo $helper
